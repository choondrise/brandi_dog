...
def main(argv: Optional[Iterable[str]] = None) -> None:
    ...
    parser.add_argument("--reward-win", type=float, default=20.0)
    parser.add_argument("--reward-loss", type=float, default=-20.0)
    parser.add_argument("--reward-team-progress", type=float, default=2.0)
    parser.add_argument("--reward-partner-progress", type=float, default=0.75)
    parser.add_argument("--reward-opponent-progress", type=float, default=-1.0)
    parser.add_argument("--reward-safe-entry", type=float, default=3.0)
    parser.add_argument("--reward-capture", type=float, default=2.0)
    parser.add_argument("--reward-discard", type=float, default=-0.15)
    parser.add_argument("--reward-sent-back", type=float, default=-3.0)
    parser.add_argument("--reward-terminal-progress", type=float, default=2.0)
